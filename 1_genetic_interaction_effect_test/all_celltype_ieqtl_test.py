...
parser = argparse.ArgumentParser(description='main3.py')
...
ieqtl_output_directory = args.output_dir
...
for i in celltype_list : 
 print(i+' start')
 tissue = celltype_tissue_mapping[celltype_tissue_mapping[0]==i][2].to_string(index=False).strip()
 #covariates
